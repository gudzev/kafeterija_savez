...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.container-item, .btn, .welcome-h1, .welcome-hr, .welcome-p, .btn-welcome, .drink-container-menu-name, .kafe-i-topli-napitci, .gazirani-sokovi, .hladni-napitci, .piva, .zestoka-pica, .vina, .vode, .energetska-pica, .drink-container-text, .star-row, .location-iframe, .map-text');
