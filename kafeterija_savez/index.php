...
<body>
    ...
    <section class="additional-links">
        ...
        <div class="container">
            ...
            <div class="container-item">
                ...
                <button class="btn"><a href="#drink-container" class="a-neutral">Karta Pića</a></button>
            ...
            <div class="container-item">
                ...
                <button class="btn"><a href="#review-container" class="a-neutral">Ocenite nas</a></button>
            ...
            <div class="container-item">
                ...
                <button class="btn"><a href="#map-container" class="a-neutral">Pronađi nas</a></button>
    ...
    <section class="review-container" id="review-container">
        ...
        <div class="review-box bg-coffee review-box-2">
